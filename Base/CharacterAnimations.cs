    ...
    public class CharacterAnimations
    {
        ...
        public void CreateAnimations()
        {
            ...
            if (player.Id == 2)
            {
                ...
                for (int i = 0; i < 4; i++)
                {
                    IntPtr frame = Engine.LoadImage($"assets/Player/NB_Right/NB_Right{i}.png");
                ...
                for (int i = 0; i < 4; i++)
                {
                    IntPtr frame = Engine.LoadImage($"assets/Player/NB_Left/NB_Left{i}.png");
                ...
                for (int i = 0; i < 5; i++)
                {
                    IntPtr frame = Engine.LoadImage($"assets/Player/NB_Up/NB_Up{i}.png");
                ...
                for (int i = 0; i < 4; i++)
                {
                    IntPtr frame = Engine.LoadImage($"assets/Player/NB_Down/NB_Down{i}.png");
                ...
                for (int i = 0; i < 1; i++)
                {
                    IntPtr frame = Engine.LoadImage($"assets/Player/NB_Idle/NB_Idle{i}.png");
